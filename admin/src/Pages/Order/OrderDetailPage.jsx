...
import { FiUser, FiMapPin, FiPhone, FiMail, FiFileText, FiPrinter, FiShoppingCart, FiList, FiTruck, FiCreditCard, FiDollarSign, FiAlertCircle } from 'react-icons/fi';
import { FaAngleRight } from "react-icons/fa6";
import toast from 'react-hot-toast';
import { fetchDataFromApi, updateData } from '../../utils/api'; // Đảm bảo đường dẫn đúng

// --- CÁC COMPONENT GIAO DIỆN CON (GIỮ NGUYÊN) ---
...
const OrderDetailPage = () => {
    ...
    if (!order) {
        return null; // Hoặc một giao diện "Không tìm thấy đơn hàng"
    }
                ...
                <div className="w-full lg:w-2/3 flex flex-col gap-6">
                    <FormSection title="Chi tiết sản phẩm & Tổng kết" icon={<FiShoppingCart />}>
                        ...
                        <div className="space-y-2 text-sm">
                            ...
                            {/* Bạn có thể thêm logic hiển thị giảm giá nếu có */}
                            <Divider />
                    ...
                    <FormSection title="Lịch sử & Ghi chú nội bộ" icon={<FiFileText />}>
                        ...
                        <Divider />
                        {/* Phần lịch sử cần backend hỗ trợ, tạm thời ẩn đi */}
                    </FormSection>
                </div>
                    ...
                    <FormSection title="Thông tin chung" icon={<FiList />}>
                        ...
                        <div className="space-y-2 text-sm">
                            <div className="flex items-center gap-2">
                                ...
                                <Typography fontWeight="medium">{order.paymentMethod}</Typography>
                            </div>
                            <div className="flex items-center gap-2">
                                <FiTruck className="text-gray-500" />
                                <Typography color="text.secondary">Lớp VC:</Typography>
                                <Typography fontWeight="medium">{order.shippingClass}</Typography>
                            </div>
                        </div>
                    </FormSection>
